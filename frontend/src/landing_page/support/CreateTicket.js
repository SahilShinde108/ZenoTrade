    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-4 mt-2 mb-2">
          ...
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Company, Partership and HUF Account Opening</a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>NRI Account Opening</a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Charges at ZenoTrade</a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>ZenoTrade IDFC FIRST Bank 3-in-1 Account</a>
          <br />
        ...
        <div className="col-4 p-4 mt-2 mb-2">
          <h4 className="mb-5">
            <i class="fa-solid fa-user"></i>&nbsp;Your ZenoTrade Account
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Login Credentials</a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Acccount Modification and Segment Addition</a>
          <br />
        ...
        <div className="col-4 p-4 mt-2 mb-2">
          <h4 className="mb-5">
            <i class="fa-solid fa-chart-column"></i>&nbsp;Your ZenoTrade Account
          </h4>
